...
import com.example.mipokelist.models.Result;
...
public class PokemonMockServiceImpl implements PokemonService {
    @Override
    public void getPokemons(Callback<PokemonList> responseCallback) {
        PokemonList listaPokemon = new PokemonList();
        Result pokemon = new Result();
        pokemon.setName("TEST");
        pokemon.setUrl("TEST URL");
        List<Result> results = new ArrayList<>();
        results.add(pokemon);
        listaPokemon.setResults(results);
        responseCallback.onSuccess(listaPokemon);
    }

    @Override
    public void getPokemon(String id, Callback<PokemonsEstadisticas> responseCallback) {
Gson gson = new Gson();
responseCallback.onSuccess(gson.fromJson("{\n" +
        "    \"abilities\": [\n" +
        "        {\n" +
        "            \"ability\": {\n" +
        "                \"name\": \"overgrow\",\n" +
